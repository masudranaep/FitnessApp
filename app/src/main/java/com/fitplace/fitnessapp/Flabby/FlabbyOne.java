...
public class FlabbyOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_flabby_one );
        ...
        adLoader = new AdLoader.Builder ( FlabbyOne.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = FlabbyOne.this;
    ...
    public void Warmup(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_Warmap.class);
        startActivity ( intent );

    }

    public void STRETCHING(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_Stretching.class);
        startActivity ( intent );
    }

    public void DIPS(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_Dips.class);
        startActivity ( intent );
    }

    public void Dumbbelpress(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_D_Press.class);
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show (FlabbyOne.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( FlabbyOne.this, Fm_D_Press.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void BENCHpress(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_Banchpress.class);
        startActivity ( intent );
    }

    public void DumbbeleFly(View view) {

        Intent intent = new Intent (FlabbyOne.this, Fm_D_Fly.class);
        startActivity ( intent );
    }

    public void FrontPress(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_FrontPress.class);
        startActivity ( intent );

    }

    public void BackPulley(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_BackPulley.class);
        startActivity ( intent );
    ...
    public void SaatedCableRow(View view) {
        Intent intent = new Intent (FlabbyOne.this, Fm_SeatedCable.class);
        startActivity ( intent );
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (FlabbyOne.this, FlabbyGym_type.class);
        startActivity ( intent );
    }
}