...
public class FlabbyTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_flabby_two );
        ...
        adLoader = new AdLoader.Builder ( FlabbyTwo.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = FlabbyTwo.this;
    ...
    public void JOGGING(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Jogging.class);
        startActivity ( intent );
    }

    public void DELTOIDPRESS(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_Dumbbelpressshol.class);
        startActivity ( intent );
    ...
    public void ARMS_FRONT_RAISE(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_ArmsFrontraise.class);
        startActivity ( intent );

    }

    public void ARMSWORK(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_ArmsWork.class);
        startActivity ( intent );
        showRewardedAd ();
    }

    public void ARMsbicecurl(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_BricepCurl.class);
        startActivity ( intent );
    }

    public void HAMMERCURL(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_Hammercurl.class);
        startActivity ( intent );
    }

    public void TRICEP_PULLEY(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_TricepPulley.class);
        startActivity ( intent );
        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( FlabbyTwo.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( FlabbyTwo.this, Fm_TricepPulley.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void TricepStand(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_TricepStand.class);
        startActivity ( intent );
    }

    public void TRIKICK(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_Kick.class);
        startActivity ( intent );

    }

    public void FOREArms(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_ForeArms.class);
        startActivity ( intent );

    }

    public void LEGS_SQUAT(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_LegsSquat.class);
        startActivity ( intent );
    }

    public void LEGS_EX(View view) {
        Intent intent = new Intent (FlabbyTwo.this, Fm_Legsex.class);
        startActivity ( intent );
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (FlabbyTwo.this, FlabbyGym_type.class);
        startActivity ( intent );
    }
}