...
public class FlabbyDite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_flabby_dite );
        ...
        adLoader = new AdLoader.Builder ( FlabbyDite.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (FlabbyDite.this, FlabbyGym_type.class );
