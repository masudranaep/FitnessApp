...
public class SkinnyDeit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_skinny_deit );
        ...
        //native ads
        adLoader = new AdLoader.Builder( SkinnyDeit.this,"ca-app-pub-6814304072623948/2794571806")
...
//                        template2.setNativeAd(NativeAd);
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (SkinnyDeit.this, Skinny_GymType.class);
