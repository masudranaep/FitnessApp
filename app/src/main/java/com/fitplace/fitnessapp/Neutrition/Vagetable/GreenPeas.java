...
public class GreenPeas extends AppCompatActivity {

    private  AdLoader adLoader;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_green_peas );
        ...
        adLoader = new AdLoader.Builder ( GreenPeas.this, "ca-app-pub-6814304072623948/2794571806" )
