...
import com.fitplace.fitnessapp.Neutrition.Vagetable.Cuumber;
...
public class KidneyDetox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_kidney_detox );
        ...
        adLoader = new AdLoader.Builder (KidneyDetox.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = KidneyDetox.this;
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (KidneyDetox.this, HealYourBody.class);
        startActivity ( intent );
    }

    public void Cilantro(View view) {
        Intent intent = new Intent (KidneyDetox.this, Spinach.class);
        startActivity ( intent );
        showRewardedAd ();
    ...
    public void Carrots(View view) {
        Intent intent = new Intent (KidneyDetox.this, Carrots.class);
        startActivity ( intent );
    ...
    public void Grapes(View view) {
        Intent intent = new Intent (KidneyDetox.this, Grape.class);
        startActivity ( intent );

    }

    public void Cucumber(View view) {
        Intent intent = new Intent (KidneyDetox.this, Cuumber.class);
        startActivity ( intent );
    ...
    public void Watermelon(View view) {
        Intent intent = new Intent (KidneyDetox.this, Watermelon.class);
        startActivity ( intent );

    }

    public void BellPepper(View view) {
        Intent intent = new Intent (KidneyDetox.this, Bellpepper.class);
        startActivity ( intent );
    ...
    public void Cabbage(View view) {
        Intent intent = new Intent (KidneyDetox.this, Cabbage.class);
        startActivity ( intent );

    }

    public void MustardGreens(View view) {
        Intent intent = new Intent (KidneyDetox.this, Pumpkin.class);
        startActivity ( intent );
    ...
    public void Apple(View view) {
        Intent intent = new Intent (KidneyDetox.this, Apple.class);
        startActivity ( intent );

    }

    public void Raspberry(View view) {
        Intent intent = new Intent (KidneyDetox.this,  Raspberry.class);
        startActivity ( intent );
    ...
    public void Ginger(View view) {
        Intent intent = new Intent (KidneyDetox.this, Ginger.class);
        startActivity ( intent );
