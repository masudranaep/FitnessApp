...
public class Banana extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Banana.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Banana.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Banana.this, Fruits.class);
