...
public class Walnuts extends AppCompatActivity {

    private AdLoader adLoader;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_walnuts );
        ...
        adLoader = new AdLoader.Builder ( Walnuts.this, "ca-app-pub-6814304072623948/2794571806" )
