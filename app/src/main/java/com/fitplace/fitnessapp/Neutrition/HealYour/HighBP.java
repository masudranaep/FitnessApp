...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( HighBP.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = HighBP.this;
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (HighBP.this, HealYourBody.class );
        startActivity ( intent );
    }

    public void BlackGram(View view) {

        Intent intent = new Intent (HighBP.this, Blueberries.class );
        startActivity ( intent );
        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( HighBP.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( HighBP.this, Blueberries.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Cucumber(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Cuumber.class );
        startActivity ( intent );
    ...
    public void Kiwi(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Kiwi.class );
        startActivity ( intent );
    ...
    public void Garlic(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Garlic.class );
        startActivity ( intent );
    ...
    public void Pomegranate(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Pomegrante.class );
        startActivity ( intent );
    ...
    public void spinach(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Spinach.class );
        startActivity ( intent );
    ...
    public void Apple(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Apple.class );
        startActivity ( intent );
    ...
    public void Beetroot(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Beetroot.class );
        startActivity ( intent );
    ...
    public void Tomato(View view) {
        ...
        Intent intent = new Intent (HighBP.this, Tomato.class );
        startActivity ( intent );
        showRewardedAd ();
