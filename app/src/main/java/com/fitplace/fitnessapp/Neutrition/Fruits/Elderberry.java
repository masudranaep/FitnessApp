...
public class Elderberry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_elderberry );
        ...
        adLoader = new AdLoader.Builder ( Elderberry.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Elderberry.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Elderberry.this, Fruits.class);
