...
public class SweetPototo extends AppCompatActivity {
    private AdLoader adLoader;
    private AdView adView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_sweet_pototo );
        ...
        adLoader = new AdLoader.Builder ( SweetPototo.this, "ca-app-pub-6814304072623948/2794571806" )
