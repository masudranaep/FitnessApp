...
public class Almonds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Almonds.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
        ...
        private void showRewardedAd() {
            if (mRewardedAd != null) {
                Activity activityContext = Almonds.this;
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (Almonds.this, Fruits.class);
