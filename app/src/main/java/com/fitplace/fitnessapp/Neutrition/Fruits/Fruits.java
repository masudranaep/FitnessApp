package com.fitplace.fitnessapp.Neutrition.Fruits;
...
import com.fitplace.fitnessapp.Neutrition.BestFood.Raspberry;
import com.fitplace.fitnessapp.Neutrition.ImmunityBost.Orange;
...
public class Fruits extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Fruits.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template3.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Fruits.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Fruits.this, NutritionFacts.class );
    ...
    public void Avocado(View view) {
        Intent intent = new Intent (Fruits.this, Avocado.class);
        startActivity ( intent );
        ...
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Fruits.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fruits.this, Avocado.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void BlackBerries(View view) {
        Intent intent = new Intent (Fruits.this, Blueberries.class);
        startActivity ( intent );

    }

    public void Cherry(View view) {
        Intent intent = new Intent (Fruits.this, Cherry.class);
        startActivity ( intent );
    }

    public void Dates(View view) {
        Intent intent = new Intent (Fruits.this, Dates.class);
        startActivity ( intent );
    ...
    public void JackFruit(View view) {
        Intent intent = new Intent (Fruits.this, Jackfruit.class);
        startActivity ( intent );

    }

    public void Lemon(View view) {
        Intent intent = new Intent (Fruits.this, Lemon.class);
        startActivity ( intent );
    ...
    public void Papaya(View view) {
        ...
        if(mInterstitialAd != null){
            ...
            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                ...
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fruits.this, Papaya.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Pomegranate(View view) {
        ...
        Intent intent = new Intent (Fruits.this, Pomegrante.class);
        startActivity ( intent );

    }

    public void Quince(View view) {
        Intent intent = new Intent (Fruits.this, Quince.class);
        startActivity ( intent );
    }

    public void Strawberry(View view) {

        Intent intent = new Intent (Fruits.this, Strawberry.class);
        startActivity ( intent );
    }
    ...
    public void Pears(View view) {
        Intent intent = new Intent (Fruits.this, Pears.class);
        startActivity ( intent );

    }

    public void Raspberry(View view) {
        Intent intent = new Intent (Fruits.this, Raspberry.class);
        startActivity ( intent );

    }

    public void Cherimoya(View view) {
        Intent intent = new Intent (Fruits.this, Cherry.class);
        startActivity ( intent );
        showRewardedAd ();
    ...
    public void Durian(View view) {
        ...
        Intent intent = new Intent (Fruits.this, Durian.class);
        startActivity ( intent );

    }

    public void Kiwi(View view) {
        Intent intent = new Intent (Fruits.this, Kiwi.class);
        startActivity ( intent );
    ...
    public void ElderBerry(View view) {
        Intent intent = new Intent (Fruits.this, Elderberry.class);
        startActivity ( intent );
