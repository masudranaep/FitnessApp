...
public class Chicken extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Chicken.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Chicken.this;
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (Chicken.this, NutritionFacts.class );
