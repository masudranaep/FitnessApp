...
public class Acaiberry extends AppCompatActivity {
    private AdView adView;
    private  AdLoader adLoader;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_acaiberry );
...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( Acaiberry.this, "ca-app-pub-6814304072623948/2794571806" )
