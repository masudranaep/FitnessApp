...
import com.fitplace.fitnessapp.Neutrition.ImmunityBost.GreenTea;
...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( SkinCare.this, "ca-app-pub-6814304072623948/2794571806" )
...
//
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = SkinCare.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (SkinCare.this, HealYourBody.class);
    ...
    public void Almonds(View view) {
        ...
        Intent intent = new Intent (SkinCare.this, Almonds.class);
        startActivity ( intent );

    }

    public void Apple(View view) {
        Intent intent = new Intent (SkinCare.this, Apple.class);
        startActivity ( intent );

    }

    public void Avocado(View view) {
        Intent intent = new Intent (SkinCare.this, Avocado.class);
        startActivity ( intent );
    ...
    public void Beetrot(View view) {
        Intent intent = new Intent (SkinCare.this, Beetroot.class);
        startActivity ( intent );
    ...
    public void GreenTea(View view) {
        Intent intent = new Intent (SkinCare.this, GreenTea.class);
        startActivity ( intent );
        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( SkinCare.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( SkinCare.this, GreenTea.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Watermelon(View view) {
        Intent intent = new Intent (SkinCare.this, Watermelon.class);
        startActivity ( intent );

    }

    public void SwissChard(View view) {
        Intent intent = new Intent (SkinCare.this, Spinach.class);
        startActivity ( intent );
        showRewardedAd ();
    ...
    public void Carrots(View view) {
        Intent intent = new Intent (SkinCare.this, Carrots.class);
        startActivity ( intent );

    }

    public void Blueberries(View view) {
        Intent intent = new Intent (SkinCare.this, Blueberries.class);
        startActivity ( intent );
    ...
    public void Salmon(View view) {
        Intent intent = new Intent (SkinCare.this, Salmon.class);
        startActivity ( intent );

    }

    public void SweetPotato(View view) {
        Intent intent = new Intent (SkinCare.this, SweetPototo.class);
        startActivity ( intent );
    ...
    public void PumpkingSeeds(View view) {
        ...
        Intent intent = new Intent (SkinCare.this, Pumpkin.class);
        startActivity ( intent );

    }

    public void WinterSquash(View view) {
        Intent intent = new Intent (SkinCare.this, Watermelon.class);
        startActivity ( intent );
    }
}