...
import com.fitplace.fitnessapp.Neutrition.Fruits.Cherry;
...
public class UlcerPro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_ulcer_pro );
...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( UlcerPro.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = UlcerPro.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (UlcerPro.this, HealYourBody.class);
        startActivity ( intent );

    }

    public void Cabbage(View view) {
        Intent intent = new Intent (UlcerPro.this, Cabbage.class);
        startActivity ( intent );
    ...
    public void Celery(View view) {
        Intent intent = new Intent (UlcerPro.this, Cherry.class);
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( UlcerPro.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( UlcerPro.this, Cherry.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Broccoli(View view) {
        Intent intent = new Intent (UlcerPro.this, Broccoli.class);
        startActivity ( intent );
    }

    public void Chamomile(View view) {
        Intent intent = new Intent (UlcerPro.this, ChamomileTea.class);
        startActivity ( intent );
    ...
    public void Cranberries(View view) {
        Intent intent = new Intent (UlcerPro.this, Spinach.class);
        startActivity ( intent );

    }

    public void Garlic(View view) {
        Intent intent = new Intent (UlcerPro.this, Garlic.class);
        startActivity ( intent );


    }

    public void Tumeric(View view) {
        Intent intent = new Intent (UlcerPro.this, Tomato.class);
        startActivity ( intent );
        showRewardedAd ();
    }
    ...
    public void SweetPotato(View view) {
        ...
        Intent intent = new Intent (UlcerPro.this, SweetPototo.class);
        startActivity ( intent );
    }

    public void BellPepper(View view) {
        Intent intent = new Intent (UlcerPro.this, Bellpepper.class);
        startActivity ( intent );
    ...
    public void Carrots(View view) {
        Intent intent = new Intent (UlcerPro.this, Carrots.class);
        startActivity ( intent );
    }
