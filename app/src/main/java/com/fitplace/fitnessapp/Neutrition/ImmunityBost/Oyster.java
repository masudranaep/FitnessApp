...
public class Oyster extends AppCompatActivity {

    private AdLoader adLoader;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_oyster2 );
        ...
        adLoader = new AdLoader.Builder ( Oyster.this, "ca-app-pub-6814304072623948/2794571806" )
