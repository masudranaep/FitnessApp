...
import com.fitplace.fitnessapp.Neutrition.Fruits.Strawberry;
import com.fitplace.fitnessapp.Neutrition.NonVege.Egg;
import com.fitplace.fitnessapp.Neutrition.NonVege.Salmon;
import com.fitplace.fitnessapp.Neutrition.Vagetable.Apricot;
...
public class LongerHair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_longer_hair );
        ...
        adLoader = new AdLoader.Builder ( LongerHair.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = LongerHair.this;
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (LongerHair.this, HealYourBody.class);
        startActivity ( intent );
    }

    public void Apricot(View view) {
        Intent intent = new Intent (LongerHair.this, Apricot.class);
        startActivity ( intent );

    }

    public void Avocado(View view) {
        Intent intent = new Intent (LongerHair.this, Avocado.class);
        startActivity ( intent );


        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( LongerHair.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( LongerHair.this, Avocado.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Blueberries(View view) {
        Intent intent = new Intent (LongerHair.this, Blueberries.class);
        startActivity ( intent );

    }

    public void Broccoli(View view) {
        Intent intent = new Intent (LongerHair.this, Broccoli.class);
        startActivity ( intent );
        showRewardedAd ();
    ...
    public void BellPepper(View view) {
        Intent intent = new Intent (LongerHair.this, Bellpepper.class);
        startActivity ( intent );
    }

    public void Carrots(View view) {

        Intent intent = new Intent (LongerHair.this, Carrots.class);
        startActivity ( intent );
    }
    ...
    public void Eggs(View view) {
        ...
        Intent intent = new Intent (LongerHair.this, Egg.class);
        startActivity ( intent );
    ...
    public void Papaya(View view) {
        Intent intent = new Intent (LongerHair.this, Papaya.class);
        startActivity ( intent );

    }

    public void Salmon(View view) {
        Intent intent = new Intent (LongerHair.this, Salmon.class);
        startActivity ( intent );
    ...
    public void SweetPotato(View view) {
        Intent intent = new Intent (LongerHair.this, SweetPototo.class);
        startActivity ( intent );
    ...
    public void Asparagus(View view) {
        Intent intent = new Intent (LongerHair.this, Asparagus.class);
        startActivity ( intent );

    }

    public void PumpkingSeeds(View view) {
        Intent intent = new Intent (LongerHair.this, Pumpkin.class);
        startActivity ( intent );

    }


    public void Straberry(View view) {
        Intent intent = new Intent (LongerHair.this, Strawberry.class);
        startActivity ( intent );
showRewardedAd ();
    }
}