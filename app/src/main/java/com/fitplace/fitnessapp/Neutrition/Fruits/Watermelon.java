...
public class Watermelon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Watermelon.this, "ca-app-pub-6814304072623948/2794571806" )
...
//
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Watermelon.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Watermelon.this, Fruits.class);
