...
public class Prawns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Prawns.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Prawns.this;
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (Prawns.this, NutritionFacts.class );
