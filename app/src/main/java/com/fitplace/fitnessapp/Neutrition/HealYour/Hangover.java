...
public class Hangover extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_hangover );
...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( Hangover.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Hangover.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Hangover.this, HealYourBody.class );
        startActivity ( intent );
    }

    public void Carrots(View view) {
        Intent intent = new Intent (Hangover.this, Carrots.class );
        startActivity ( intent );

    }

    public void Lemon(View view) {
        Intent intent = new Intent (Hangover.this, Lemon.class );
        startActivity ( intent );
    ...
    public void Banana(View view) {
        ...
        Intent intent = new Intent (Hangover.this, Banana.class );
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Hangover.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Hangover.this, Banana.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void SweetPotato(View view) {
        ...
        Intent intent = new Intent (Hangover.this, SweetPototo.class );
        startActivity ( intent );
    }

    public void Salmon(View view) {

        Intent intent = new Intent (Hangover.this, Salmon.class );
        startActivity ( intent );

    }

    public void Orange(View view) {
        Intent intent = new Intent (Hangover.this, Orange.class );
        startActivity ( intent );
        showRewardedAd ();
    ...
    public void Apple(View view) {
        Intent intent = new Intent (Hangover.this, Apple.class );
        startActivity ( intent );

    }

    public void Beetroot(View view) {
        Intent intent = new Intent (Hangover.this, Beetroot.class );
        startActivity ( intent );
        ...
        if(mInterstitialAd != null){
            ...
            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                ...
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Hangover.this, Beetroot.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Tomato(View view) {
        Intent intent = new Intent (Hangover.this, Tomato.class );
        startActivity ( intent );

    }

    public void Avocado(View view) {
        Intent intent = new Intent (Hangover.this, Avocado.class );
        startActivity ( intent );

    }

    public void Blueberries(View view) {
        Intent intent = new Intent (Hangover.this, Blueberries.class );
        startActivity ( intent );
    ...
    public void spinach(View view) {
        Intent intent = new Intent (Hangover.this, Spinach.class );
        startActivity ( intent );
