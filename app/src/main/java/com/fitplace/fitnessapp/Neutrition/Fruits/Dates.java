        ...
        MobileAds.initialize(this, new OnInitializationCompleteListener () {
            ...
            public void onInitializationComplete(InitializationStatus initializationStatus) {
                loadRewaededAd ();
                    ...
                    adLoader = new AdLoader.Builder ( Dates.this, "ca-app-pub-6814304072623948/2794571806" )
...
//
        ...
        private void showRewardedAd() {
            if (mRewardedAd != null) {
                Activity activityContext = Dates.this;
    ...
    public void Dates(View view) {
        Intent intent = new Intent (Dates.this, Fruits.class);
