...
import com.fitplace.fitnessapp.Neutrition.ImmunityBost.Lima;
...
public class KidneyStone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_kidney_stone );
        ...
        adLoader = new AdLoader.Builder (KidneyStone.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    public void Lemon(View view) {
        ...
        Intent intent = new Intent (KidneyStone.this, Lemon.class );
    ...
    public void Pomegranate(View view) {
        ...
        Intent intent = new Intent (KidneyStone.this, NutritionFacts.class );
        startActivity ( intent );
    ...
    public void Basil(View view) {
        Intent intent = new Intent (KidneyStone.this, Basil.class );
        startActivity ( intent );

    }

    public void Dandelion(View view) {
        Intent intent = new Intent (KidneyStone.this, Lima.class );
        startActivity ( intent );

    }

    public void Celery(View view) {
        Intent intent = new Intent (KidneyStone.this, Cherry.class );
        startActivity ( intent );

    }

    public void Orange(View view) {
        Intent intent = new Intent (KidneyStone.this, Orange.class );
        startActivity ( intent );

    }

    public void Backpass(View view) {
        Intent intent = new Intent (KidneyStone.this, HealYourBody.class );
        startActivity ( intent );

    }

    public void Watermelon(View view) {
        Intent intent = new Intent (KidneyStone.this, Watermelon.class );
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( KidneyStone.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( KidneyStone.this, Watermelon.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Apple(View view) {
        Intent intent = new Intent (KidneyStone.this, Apple.class );
        startActivity ( intent );
