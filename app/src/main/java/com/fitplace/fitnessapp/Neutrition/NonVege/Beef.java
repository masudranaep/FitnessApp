...
public class Beef extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Beef.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Beef.this;
    ...
    public void Backpass(View view) {
        ...
        Intent intent = new Intent (Beef.this, NutritionFacts.class );
