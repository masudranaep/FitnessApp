...
public class Cuumber extends AppCompatActivity {
    private AdLoader adLoader;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_cuumber );
        ...
        adLoader = new AdLoader.Builder ( Cuumber.this, "ca-app-pub-6814304072623948/2794571806" )
