...
public class ChamomileTea extends AppCompatActivity {
 private  AdLoader adLoader;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_chamomile_tea );
        ...
        adLoader = new AdLoader.Builder ( ChamomileTea.this, "ca-app-pub-6814304072623948/2794571806" )
