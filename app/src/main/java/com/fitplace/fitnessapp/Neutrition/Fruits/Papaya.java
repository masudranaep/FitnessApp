...
public class Papaya extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( Papaya.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Papaya.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Papaya.this, Fruits.class);
