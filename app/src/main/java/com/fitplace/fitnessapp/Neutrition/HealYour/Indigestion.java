...
import com.fitplace.fitnessapp.Neutrition.Fruits.PineApple;
import com.fitplace.fitnessapp.Neutrition.Vagetable.Caromseeds;
...
public class Indigestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder (Indigestion.this, "ca-app-pub-6814304072623948/2794571806" )
...
////                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Indigestion.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Indigestion.this, HealYourBody.class );
        startActivity ( intent );
    }

    public void Banana(View view) {
        Intent intent = new Intent (Indigestion.this, Banana.class );
        startActivity ( intent );
    ...
    public void Lemon(View view) {
        Intent intent = new Intent (Indigestion.this, Lemon.class );
        startActivity ( intent );
    ...
    public void Peppermint(View view) {
        ...
        Intent intent = new Intent (Indigestion.this, Papaya.class );
        startActivity ( intent );
    ...
    public void Pineapple(View view) {
        ...
        Intent intent = new Intent (Indigestion.this, PineApple.class );
        startActivity ( intent );
    }

    public void CaromSeeds(View view) {
        Intent intent = new Intent (Indigestion.this, Caromseeds.class );
        startActivity ( intent );

    }

    public void GooseBerries(View view) {
        Intent intent = new Intent (Indigestion.this, Blueberries.class );
        startActivity ( intent );
    ...
    public void Carrots(View view) {
        Intent intent = new Intent (Indigestion.this, Carrots.class );
        startActivity ( intent );

    }

    public void Ginger(View view) {
        Intent intent = new Intent (Indigestion.this, Ginger.class );
        startActivity ( intent );
        showRewardedAd ();
    ...
    public void ChamomileTea(View view) {
        Intent intent = new Intent (Indigestion.this, ChamomileTea.class );
        startActivity ( intent );


    }

    public void FennelSeeds(View view) {
        Intent intent = new Intent (Indigestion.this, Pumpkin.class );
        startActivity ( intent );

    }

    public void CorianderSeeds(View view) {
        Intent intent = new Intent (Indigestion.this, Pumpkin.class );
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Indigestion.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Indigestion.this, Pumpkin.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void Avocado(View view) {
        Intent intent = new Intent (Indigestion.this, Avocado.class );
        startActivity ( intent );
