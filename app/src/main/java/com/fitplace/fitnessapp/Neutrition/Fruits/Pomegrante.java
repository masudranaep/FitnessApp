...
public class Pomegrante extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_pomegrante );
        ...
        adLoader = new AdLoader.Builder ( Pomegrante.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Pomegrante.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Pomegrante.this, Fruits.class);
