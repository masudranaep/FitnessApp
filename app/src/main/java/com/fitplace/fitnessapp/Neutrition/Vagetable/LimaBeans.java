...
public class LimaBeans extends AppCompatActivity {

    private AdLoader adLoader;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_lima_beans );
        ...
        adLoader = new AdLoader.Builder ( LimaBeans.this, "ca-app-pub-6814304072623948/2794571806" )
