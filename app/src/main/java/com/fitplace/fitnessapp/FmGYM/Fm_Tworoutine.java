...
public class Fm_Tworoutine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_fm_tworoutine );
        ...
        adLoader = new AdLoader.Builder ( Fm_Tworoutine.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Fm_Tworoutine.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, FmGym.class);
    ...
    public void Warmup(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_Warmap.class);
        startActivity ( intent );
    }

    public void STRETCHING(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_Stretching.class);
        startActivity ( intent );
    }

    public void DIPS(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_Dips.class);
        startActivity ( intent );
    ...
    public void Dumbbelpress(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_D_Press.class);
        startActivity ( intent );
    ...
    public void DumbbeleFly(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_D_Fly.class);
        startActivity ( intent );
    }

    public void ARMS_FRONT_RAISE(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_ArmsFrontraise.class);
        startActivity ( intent );
    }

    public void ARMS_SIDE_RAISE(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_ArmsSideraise.class);
        startActivity ( intent );
        showRewardedAd ();
    }

    public void ARMSWORK(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_ArmsWork.class);
        startActivity ( intent );
    }
    ...
    public void ARMsicepcurl(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_BricepCurl.class);
        startActivity ( intent );
    }

    public void TRICEP_PULLEY(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_TricepPulley.class);
        startActivity ( intent );
    }

    public void TricepStand(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_TricepStand.class);
        startActivity ( intent );
        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Fm_Tworoutine.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fm_Tworoutine.this, Fm_TricepStand.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void FOR_ARMS(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_ForeArms.class);
        startActivity ( intent );
    }

    public void LEGS_SQUAT(View view) {
        Intent intent = new Intent ( Fm_Tworoutine.this, Fm_LegsSquat.class);
        startActivity ( intent );
    }

    public void personal(View view) {
        Intent intent = new Intent (Fm_Tworoutine.this, Fm_Contact.class);
        startActivity ( intent );
