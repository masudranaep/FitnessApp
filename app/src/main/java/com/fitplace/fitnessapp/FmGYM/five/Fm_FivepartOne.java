...
public class Fm_FivepartOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_fm_fivepart_one );
...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( Fm_FivepartOne.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Fm_FivepartOne.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_Fivepart.class );
        startActivity ( intent );
    }

    public void ConsentCurl(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_Concestcurl.class );
        startActivity ( intent );
    ...
    public void Chinup(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_ChinUp.class );
        startActivity ( intent );
    }

    public void DumbbellRow(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_Dumbbellrow.class );
        startActivity ( intent );

    }

    public void BackPulley(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_BackPulley.class );
        startActivity ( intent );
    }

    public void TricepStand(View view) {

        Intent intent = new Intent (Fm_FivepartOne.this, Fm_TricepStand.class );
        startActivity ( intent );
        showRewardedAd ();
    }
    ...
    public void TRICEP_PULLEY(View view) {
        ...
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_TricepPulley.class );
        startActivity ( intent );
    }

    public void HAMMERCURL(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_Hammercurl.class );
        startActivity ( intent );

    }

    public void ARMsbicecurl(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_BricepCurl.class );
        startActivity ( intent );

    }

    public void ARMSWORK(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_ArmsWork.class );
        startActivity ( intent );
    }

    public void ARMS_FRONT_RAISE(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_ArmsFrontraise.class );
        startActivity ( intent );

    }

    public void ArmsSideStrech(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, ArmsSideStrech.class );
        startActivity ( intent );

    }

    public void DELTOIDPRESS(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_Dumbbelpressshol.class );
        startActivity ( intent );
    ...
    public void JOGGING(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Jogging.class );
        startActivity ( intent );

    }

    public void TRIKICK(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_Kick.class );
        startActivity ( intent );

    }

    public void FOREArms(View view) {
        Intent intent = new Intent (Fm_FivepartOne.this, Fm_ForeArms.class );
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Fm_FivepartOne.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fm_FivepartOne.this, Fm_ForeArms.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
