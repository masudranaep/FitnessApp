...
public class Fm_FourPartone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_fm_four_partone );
        ...
        adLoader = new AdLoader.Builder ( Fm_FourPartone.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Fm_FourPartone.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_Fourpart.class );
        startActivity ( intent );

    }

    public void Warmup(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_Warmap.class );
        startActivity ( intent );
    }

    public void STRETCHING(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_Stretching.class );
        startActivity ( intent );
    ...
    public void DIPS(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_Dips.class );
        startActivity ( intent );

    }

    public void Dumbbelpress(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_D_Press.class );
        startActivity ( intent );

    }

    public void BENCHpress(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_Banchpress.class );
        startActivity ( intent );
    ...
    public void DumbbeleFly(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_D_Fly.class );
        startActivity ( intent );

    }

    public void FrontPress(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_FrontPress.class );
        startActivity ( intent );

    }

    public void BackPulley(View view) {
        Intent intent = new Intent (Fm_FourPartone.this, Fm_BackPulley.class );
        startActivity ( intent );
        showRewardedAd ();
