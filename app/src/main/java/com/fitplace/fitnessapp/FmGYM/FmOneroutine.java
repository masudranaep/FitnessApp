...
public class FmOneroutine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_fm_oneroutine );
...
//bennaer ads
        ...
        adLoader = new AdLoader.Builder ( FmOneroutine.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = FmOneroutine.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (FmOneroutine.this, FmGym.class);
        startActivity ( intent );

    }

    public void JOGGING(View view) {
        Intent intent = new Intent (FmOneroutine.this, Jogging.class );
        startActivity ( intent );
    ...
    public void SIDETWSTING(View view) {
        ...
        Intent intent = new Intent (FmOneroutine.this, Fm_SideTwisting.class );
        startActivity ( intent );
    }
    ...
    public void PUSHUP(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_PushUp.class );
        startActivity ( intent );
    ...
    public void ARMS_FRONT_RAISE(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_ArmsFrontraise.class );
        startActivity ( intent );
    ...
    public void ARMS_SIDE_RAISE(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_ArmsSideraise.class );
        startActivity ( intent );

    }

    public void ARMSWORK(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_ArmsWork.class );
        startActivity ( intent );
    }

    public void HAMMERCURL(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_Hammercurl.class );
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( FmOneroutine.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( FmOneroutine.this, Fm_Hammercurl.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void TRICEP_PULLEY(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_TricepPulley.class );
        startActivity ( intent );
    }

    public void FOR_ARMS(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_ForeArms.class );
        startActivity ( intent );
    }

    public void LEGS_SQUAT(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_LegsSquat.class );
        startActivity ( intent );

    }

    public void personal(View view) {
        Intent intent = new Intent (FmOneroutine.this, Fm_Contact.class);
        startActivity ( intent );
    }
}