package com.fitplace.fitnessapp.FmGYM.fourNo;
...
public class Fm_FourParttwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_fm_four_parttwo );
...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( Fm_FourParttwo.this, "ca-app-pub-6814304072623948/2794571806" )
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Fm_FourParttwo.this;
    ...
    public void Backpass(View view){
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_Fourpart.class );
        startActivity ( intent );
    }

    public void DELTOIDPRESS(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_Dumbbelpressshol.class );
        startActivity ( intent );
    ...
    public void ArmsSideStrech(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_ArmsSideraise.class );
        startActivity ( intent );

    }

    public void ARMS_FRONT_RAISE(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_ArmsFrontraise.class );
        startActivity ( intent );

    }

    public void ARMSWORK(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_ForeArms.class );
        startActivity ( intent );
    ...
    public void ARMsbicecurl(View view) {
        ...
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_BricepCurl.class );
        startActivity ( intent );
    }

    public void HAMMERCURL(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_Hammercurl.class );
        startActivity ( intent );

    }

    public void TRICEP_PULLEY(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_TricepPulley.class );
        startActivity ( intent );
    ...
    public void TricepStand(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_TricepStand.class );
        startActivity ( intent );

    }

    public void TRIKICK(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_Kick.class );
        startActivity ( intent );
    ...
    public void FOREArms(View view) {
        ...
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Fm_FourParttwo.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fm_FourParttwo.this, Fm_LegsCalfraise.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void LEGS_SQUAT(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_LegsSquat.class );
        startActivity ( intent );

    }

    public void LEGS_EX(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_Legsex.class );
        startActivity ( intent );

    }

    public void CalfRaise(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Fm_LegsCalfraise.class );
        startActivity ( intent );
        showRewardedAd ();
    ...
    public void JOGGING(View view) {
        Intent intent = new Intent (Fm_FourParttwo.this, Jogging.class );
        startActivity ( intent );
