...
public class Fm_FatOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_fm_fat_one );
        ...
        adLoader = new AdLoader.Builder ( Fm_FatOne.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Fm_FatOne.this;
    ...
    public void SQUATS(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_LegsSquat.class );
        startActivity ( intent);
    }

    public void ABS(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Abs.class );
        startActivity ( intent);

    }

    public void LEGSFrontSTRETCH(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_LegfrontStrech.class );
        startActivity ( intent);
    }

    public void LegsSideStretch(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_LegsideStretch.class );
        startActivity ( intent);
    ...
    public void TRICEP_PULLEY(View view) {
        ...
        Intent intent = new Intent ( Fm_FatOne.this, Fm_TricepPulley.class );
        startActivity ( intent);
        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Fm_FatOne.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fm_FatOne.this, Fm_TricepPulley.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void HAMMERCURL(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_Hammercurl.class );
        startActivity ( intent);
    }

    public void ARMSWORK(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_ArmsWork.class );
        startActivity ( intent);
    }

    public void ARMS_SIDE_RAISE(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_ArmsSideraise.class );
        startActivity ( intent);
    ...
    public void ARMS_FRONT_RAISE(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_ArmsFrontraise.class );
        startActivity ( intent);
    }

    public void DumbbelHAflfly(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_D_Fly.class );
        startActivity ( intent);
    }

    public void PUSHUP(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_PushUp.class );
        startActivity ( intent);
        ...
        if(mInterstitialAd != null){
            ...
            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                ...
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fm_FatOne.this, Fm_PushUp.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void STRETCHING(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_Stretching.class );
        startActivity ( intent);
    }

    public void FRONTBEND(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_FrontBend.class );
        startActivity ( intent);

    }

    public void Sidebend(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_SideBend.class );
        startActivity ( intent);
        showRewardedAd ();
    }

    public void SIDETWSTING(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_SideTwisting.class );
        startActivity ( intent);
    }

    public void CYCLING(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Jogging.class );
        startActivity ( intent);
    ...
    public void TREADMILL(View view) {
        Intent intent = new Intent ( Fm_FatOne.this, Fm_Warmap.class );
        startActivity ( intent);
    }
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Fm_FatOne.this, MainActivity.class );
        startActivity ( intent );
    }
}