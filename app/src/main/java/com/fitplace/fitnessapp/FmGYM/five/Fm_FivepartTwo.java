...
public class Fm_FivepartTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_fm_fivepart_two );
        ...
        adLoader = new AdLoader.Builder ( Fm_FivepartTwo.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = Fm_FivepartTwo.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_Fivepart.class );
        startActivity ( intent);

    }

    public void Abs(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Abs.class );
        startActivity ( intent);

    }

    public void Legs(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_LegsSquat.class );
        startActivity ( intent);
    }

    public void BanchparessIN(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_Banchpress.class );
        startActivity ( intent);

    }

    public void DumbbeleFly(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_D_Fly.class );
        startActivity ( intent);

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( Fm_FivepartTwo.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( Fm_FivepartTwo.this, Fm_D_Fly.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void BENCHpressFLT(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_Banchpress.class );
        startActivity ( intent);
    ...
    public void DIPS(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_Dips.class );
        startActivity ( intent);
    ...
    public void STRETCHING(View view) {
        ...
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_Stretching.class );
        startActivity ( intent);
        showRewardedAd ();
    }
    ...
    public void Warmup(View view) {
        ...
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_Warmap.class );
        startActivity ( intent);
    }

    public void Dumbbelpress(View view) {

        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_D_Press.class );
        startActivity ( intent);
    }

    public void FrontPress(View view) {
        Intent intent = new Intent (Fm_FivepartTwo.this, Fm_FrontPress.class );
        startActivity ( intent);
