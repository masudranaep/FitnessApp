...
public class FragmentGym_2 extends Fragment {

Button btn1, btn2,btn3, btn4,btn5,btn6, btn7;

    public FragmentGym_2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate ( R.layout.fragment_gym_2, container, false );
        ...
        btn5 = v.findViewById ( R.id.Lunges );
        btn6 = v.findViewById ( R.id.wallsqut );
        btn7 = v.findViewById ( R.id.crunches );
