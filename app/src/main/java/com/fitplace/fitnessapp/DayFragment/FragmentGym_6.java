...
public class FragmentGym_6 extends Fragment {

Button btn1, btn2, btn3, btn4,btn5,btn6,btn7;

    public FragmentGym_6() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate ( R.layout.fragment_gym_6, container, false );
        ...
        btn6 = v.findViewById ( R.id.JumpingJacks );
        btn7 = v.findViewById ( R.id.degreejumping );
