...
public class HeaverWeight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_heaver_weight );
...
//        adView.loadAd(adRequest);
        ...
        btn.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                Intent intent = new Intent (HeaverWeight.this, HeavierGym_type.class);
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (HeaverWeight.this, Body_Type.class );
        startActivity ( intent );
    }
