...
public class HeaverDiet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_heaver_diet );
...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( HeaverDiet.this, "ca-app-pub-6814304072623948/2794571806")
...
//                        template2.setNativeAd ( NativeAd );
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (HeaverDiet.this, HeavierGym_type.class);
