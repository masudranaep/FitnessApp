...
public class Idealbody_Diet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_idealbody_diet );
        ...
        //Natve ads
       adLoader = new AdLoader.Builder(Idealbody_Diet.this,"ca-app-pub-6814304072623948/2794571806")
...
//                        template2.setNativeAd(NativeAd);
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (Idealbody_Diet.this, Gym_type.class );
