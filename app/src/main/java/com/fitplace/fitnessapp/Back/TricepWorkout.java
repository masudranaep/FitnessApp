...
import com.fitplace.fitnessapp.FmGYM.One.Arms.FmEzbarEx;
import com.fitplace.fitnessapp.FmGYM.One.Arms.FmRopepushd;
import com.fitplace.fitnessapp.FmGYM.One.Arms.FmRrvespush;
import com.fitplace.fitnessapp.FmGYM.One.Arms.Fm_BarbellEx;
...
public class TricepWorkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adLoader = new AdLoader.Builder ( TricepWorkout.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template2.setNativeAd ( NativeAd );
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            Activity activityContext = TricepWorkout.this;
    ...
    public void Backpass(View view) {
        Intent intent = new Intent (TricepWorkout.this, Gym_type.class );
        startActivity ( intent );
    }


    public void Warmup(View view) {
        Intent intent = new Intent (TricepWorkout.this, Fm_Warmap.class );
        startActivity ( intent );

    }

    public void PushDown(View view) {
        Intent intent = new Intent (TricepWorkout.this, Fm_TricepPulley.class );
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( TricepWorkout.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( TricepWorkout.this, Fm_TricepPulley.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void REversePushdown(View view) {

        Intent intent = new Intent (TricepWorkout.this, FmRrvespush.class );
        startActivity ( intent );
    }

    public void BenchDips(View view) {

        Intent intent = new Intent (TricepWorkout.this, Fm_TricepStand.class );
        startActivity ( intent );
    }

    public void SEatedtricepEx(View view) {

        Intent intent = new Intent (TricepWorkout.this, Fm_BarbellEx.class );
        startActivity ( intent );
        showRewardedAd ();
    }

    public void EZBARTRICEpEXten(View view) {
        Intent intent = new Intent (TricepWorkout.this, FmEzbarEx.class );
        startActivity ( intent );
    ...
    public void TRIKICK(View view) {
        ...
        Intent intent = new Intent (TricepWorkout.this, Fm_Kick.class );
        startActivity ( intent );
    }

    public void ROPEPUSHDown(View view) {

        Intent intent = new Intent (TricepWorkout.this, FmRopepushd.class );
        startActivity ( intent );
