...
//        adView.loadAd(adRequest);
        ...
        adLoader = new AdLoader.Builder ( ArmsWorkout.this, "ca-app-pub-6814304072623948/2794571806" )
...
//                        template.setNativeAd ( NativeAd );
    ...
    public  void setAds() {
        ...
        Intent intent = new Intent (ArmsWorkout.this, Gym_type.class );
        startActivity ( intent );
    }

    public void Warmup(View view) {
        Intent intent = new Intent (ArmsWorkout.this, Fm_Warmap.class );
        startActivity ( intent );
    }

    public void DumbbellCurl(View view) {

        Intent intent = new Intent (ArmsWorkout.this, Fm_BricepCurl.class );
        startActivity ( intent );

    }

    public void BarbellCURL(View view) {

        Intent intent = new Intent (ArmsWorkout.this, Fm_Barbellcurl.class );
        startActivity ( intent );
    }

    public void InclineBicepcurl(View view) {
        Intent intent = new Intent (ArmsWorkout.this, Fm_InclineBarbellCurl.class );
        startActivity ( intent );

    }

    public void HAMMERCURL(View view) {
        Intent intent = new Intent (ArmsWorkout.this, Fm_Hammercurl.class );
        startActivity ( intent );

        //interstitialAd
        if(mInterstitialAd != null){
            mInterstitialAd.show ( ArmsWorkout.this );

            mInterstitialAd.setFullScreenContentCallback ( new FullScreenContentCallback () {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent ();
                    startActivity (new Intent ( ArmsWorkout.this, Fm_Hammercurl.class ));
                    mInterstitialAd = null;
                    setAds ();
                }
            } );
    ...
    public void CONCENTRATIONCURLS(View view) {
        Intent intent = new Intent (ArmsWorkout.this, Fm_Concestcurl.class );
        startActivity ( intent );
    }

    public void ArmsPreacherCurl(View view) {
        Intent intent = new Intent (ArmsWorkout.this, Fm_Precarcurl.class );
        startActivity ( intent );

    }

    public void personal(View view) {
        Intent intent = new Intent (ArmsWorkout.this, MyContact.class );
        startActivity ( intent );
